...
switch attack
    ...
    case 'AWGN'
        watermarked_image = awgn(watermarked_image,param);
    case 'Salt and pepper noise'
        watermarked_image = noiseSaltPepper(watermarked_image,param);
    case 'Speckle noise'
    ...
    case 'Rotating attack'
        watermarked_image = rotatAttack(watermarked_image,param);
    case 'Motion blur'
    ...
    case 'Rescaling'
        watermarked_image = rescaleAttack(watermarked_image,param);
